...
| --- | --- | --- | --- | --- |
| `stair-straight-card` | `docs/assets/calculator-preview/svg/stair-straight-card.svg` | `docs/assets/calculator-preview/screenshots/stair-straight-card.png` | `buildGeometry → ready_straight` | Один прямой марш: один прямоугольник flight1, горизонтальная линия подъёма, деления ступеней только вдоль одного марша. |
| `stair-turn-90-card` | `docs/assets/calculator-preview/svg/stair-turn-90-card.svg` | `docs/assets/calculator-preview/screenshots/stair-turn-90-card.png` | `buildGeometry → empty_l_right` | Г-образный поворот 90° без готовой площадки и без забежных: два перпендикулярных плеча и поворотная зона проёма; в системе замеров отдельного ready-варианта «без площадки/без забежных» нет. |
| `stair-turn-180-card` | `docs/assets/calculator-preview/svg/stair-turn-180-card.svg` | `docs/assets/calculator-preview/screenshots/stair-turn-180-card.png` | `buildGeometry → ready_u_landing_left` | П-образная лестница: два параллельных марша flight1/flight2 и общий разворотный прямоугольник turn между ними. |
| `stair-landing-card` | `docs/assets/calculator-preview/svg/stair-landing-card.svg` | `docs/assets/calculator-preview/screenshots/stair-landing-card.png` | `buildGeometry → ready_l_right_landing` | Г-образная лестница с площадкой: два перпендикулярных марша и квадратная поворотная зона turn без клиновидных winder-полигонов. |
| `stair-winder-card` | `docs/assets/calculator-preview/svg/stair-winder-card.svg` | `docs/assets/calculator-preview/screenshots/stair-winder-card.png` | `buildGeometry → ready_l_right_winder → buildWinderPolygons` | Г-образная лестница с забежными: два перпендикулярных марша и 5 клиновидных winder-step полигонов в углу. |
